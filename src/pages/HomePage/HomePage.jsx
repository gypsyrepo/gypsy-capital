      ...
      <div className={styles.aboutSection}>
        <Row className={styles.container}>
          <Col sm={12} md={6} className="mb-5">
            ...
            <h2>
              Creating impactful value-driven financial services in Nigeria.
            </h2>
            <p>
              Gypsy Capital is a financial solutions service company, with a
              sole commitment to helping individuals achieve personal goals
              through financial intermediation.
            </p>
            <p>
              We are committed to a life of financial freedom, for individuals
              seeking the power to do more. We offer simple and smart solutions,
              you can trust.
            </p>
            <p>
              Our core vision is to impact and empower our environment and
              creating a life of financial freedom for individuals seeking the
              power to do more.
            </p>
            <p className={styles.founderQuote}>
              “No matter what your personal goals may be, at Gypsy, we are
              invested in you, if you have the credible financial data”.
            </p>
            <p className={styles.quoter}>
              <span>Ayo M.,</span> CEO Gypsy Capital
            </p>
          ...
          <Row>
            <Col sm={12} lg={6} className="mb-5">
              ...
              >
                ...
                <p>
                  Access convenient personal and lifestyle loans. We are
                  committed to providing consumer loan services, with efficiency
                  and convenience at the forefront of all we do while ensuring
                  best practices.
                </p>
              </div>
            </Col>
            <Col sm={12} lg={6}>
              ...
              >
                ...
                <h3>Gypsy Notes</h3>
                <p>
                  Earn more with us. Our investment arm is driven by our
                  interest in real estate financing, financial services,
                  agriculture and hospitality projects. We are focused on
                  delivering solutions that inspire global possibilities that
            ...
            <Col sm={12} lg={6} className="mb-5">
              ...
              >
                ...
                <p>
                  ...
                  services to individual lifestyle needs. With a diverse range
                  of industry experts, global knowledge and insight we achieve
                  ranging clientele needs.
                </p>
              </div>
            </Col>
            <Col sm={12} lg={6} className="mb-5">
        ...
        <div className={styles.container}>
          <div className={styles.styledBox}>
              ...
              <Col sm={12} lg={6}>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (!includesAlphabet) {
                      setLoanRequest(convertedToNumber.toLocaleString());
                    }
                  }}
                />
                <button
            ...
            <img
              src={CirclePattern}
              alt="pattern"
              className={styles.circlePatternOne}
            />
            <img
              src={CirclePattern}
              alt="pattern"
              className={styles.circlePatternTwo}
            />
            <div
              className={[styles.firstCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.secondCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.thirdCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.fourthCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.fifthCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.sixthCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.seventhCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.eigthCircle, styles.circle].join(" ")}
            ></div>
            <div
              className={[styles.ninthCircle, styles.circle].join(" ")}
            ></div>
          </div>
        </div>
      </div>
